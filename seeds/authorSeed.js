exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('author').insert({
      ...
      author_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg'}),
    knex('author').insert({
      id: 2,
      first_name: "Allen B.",
      last_name: "Downey",
    ...
    knex('author').insert({
      ...
      author_url: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg"
    }),
    knex('author').insert({
      id: 6,
      first_name: "Steve",
      ...
      author_url: "https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg"
    })
  );
};
